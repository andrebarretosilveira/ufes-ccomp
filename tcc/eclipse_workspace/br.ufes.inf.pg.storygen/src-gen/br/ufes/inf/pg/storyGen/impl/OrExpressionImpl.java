 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufes.inf.pg.storyGen.impl.OrExpressionImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrExpressionImpl extends ExpressionImpl implements OrExpression
{
  ...
  {
    return StoryGenPackage.Literals.OR_EXPRESSION;
  }
  ...
  public EList<Expression> getOperands()
  {
    if (operands == null)
    {
      operands = new EObjectContainmentEList<Expression>(Expression.class, this, StoryGenPackage.OR_EXPRESSION__OPERANDS);
    }
    return operands;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case StoryGenPackage.OR_EXPRESSION__OPERANDS:
