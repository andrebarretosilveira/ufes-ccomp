 ...
 */
package br.ufes.inf.serializer;
...
public class StoryGenSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Attribute(ISerializationContext context, Attribute semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, StoryGenPackage.Literals.ATTRIBUTE__ATTR_TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, StoryGenPackage.Literals.ATTRIBUTE__ATTR_TYPE));
			if (transientValues.isValueTransient(semanticObject, StoryGenPackage.Literals.ATTRIBUTE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, StoryGenPackage.Literals.ATTRIBUTE__NAME));
		}
	...
	protected void sequence_BinaryBoolExp(ISerializationContext context, BinaryBoolExp semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, StoryGenPackage.Literals.BINARY_BOOL_EXP__LEFT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, StoryGenPackage.Literals.BINARY_BOOL_EXP__LEFT));
			if (transientValues.isValueTransient(semanticObject, StoryGenPackage.Literals.BINARY_BOOL_EXP__BOOL_OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, StoryGenPackage.Literals.BINARY_BOOL_EXP__BOOL_OP));
			if (transientValues.isValueTransient(semanticObject, StoryGenPackage.Literals.BINARY_BOOL_EXP__RIGHT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, StoryGenPackage.Literals.BINARY_BOOL_EXP__RIGHT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_BinaryQntyExp(ISerializationContext context, BinaryQntyExp semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, StoryGenPackage.Literals.BINARY_QNTY_EXP__LEFT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, StoryGenPackage.Literals.BINARY_QNTY_EXP__LEFT));
			if (transientValues.isValueTransient(semanticObject, StoryGenPackage.Literals.BINARY_QNTY_EXP__NUM_OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, StoryGenPackage.Literals.BINARY_QNTY_EXP__NUM_OP));
			if (transientValues.isValueTransient(semanticObject, StoryGenPackage.Literals.BINARY_QNTY_EXP__RIGHT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, StoryGenPackage.Literals.BINARY_QNTY_EXP__RIGHT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 *     NegateBoolExp returns BoolExp
	 *
	 * Constraint:
	 *     ((left=BoolExp boolOp=BoolOp right=BoolExp) | binaryBool=BinaryBoolExp | binaryQnty=BinaryQntyExp | negateBoolExp=NegateBoolExp | unaryBool=UnaryBoolExp)
	 */
	...
	protected void sequence_Condition(ISerializationContext context, Condition semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, StoryGenPackage.Literals.CONDITION__BOOL_EXP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, StoryGenPackage.Literals.CONDITION__BOOL_EXP));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
