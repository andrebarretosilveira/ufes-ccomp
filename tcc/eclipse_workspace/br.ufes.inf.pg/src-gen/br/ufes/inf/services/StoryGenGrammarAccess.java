...
public class StoryGenGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class StoryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.Story");
	...
	public class WorldElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.World");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AttributeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.Attribute");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EventElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.Event");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConditionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.Condition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BoolExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.BoolExp");
		...
		private final RuleCall cLeftBoolExpParserRuleCall_0_1_0 = (RuleCall)cLeftAssignment_0_1.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_0_2 = (Keyword)cGroup_0.eContents().get(2);
		private final Assignment cBoolOpAssignment_0_3 = (Assignment)cGroup_0.eContents().get(3);
		private final RuleCall cBoolOpBoolOpEnumRuleCall_0_3_0 = (RuleCall)cBoolOpAssignment_0_3.eContents().get(0);
		...
		private final RuleCall cRightBoolExpParserRuleCall_0_5_0 = (RuleCall)cRightAssignment_0_5.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_0_6 = (Keyword)cGroup_0.eContents().get(6);
		private final Assignment cBinaryBoolAssignment_1 = (Assignment)cAlternatives.eContents().get(1);
		private final RuleCall cBinaryBoolBinaryBoolExpParserRuleCall_1_0 = (RuleCall)cBinaryBoolAssignment_1.eContents().get(0);
		...
		//BoolExp:
		//	'(' left=BoolExp ')' boolOp=BoolOp '(' right=BoolExp ')' | binaryBool=BinaryBoolExp | binaryQnty=BinaryQntyExp |
		//	negateBoolExp=NegateBoolExp | unaryBool=UnaryBoolExp;
		@Override public ParserRule getRule() { return rule; }
		...
		//BoolExp
		public RuleCall getLeftBoolExpParserRuleCall_0_1_0() { return cLeftBoolExpParserRuleCall_0_1_0; }
		
		//')'
		public Keyword getRightParenthesisKeyword_0_2() { return cRightParenthesisKeyword_0_2; }
		
		//boolOp=BoolOp
		public Assignment getBoolOpAssignment_0_3() { return cBoolOpAssignment_0_3; }
		
		//BoolOp
		public RuleCall getBoolOpBoolOpEnumRuleCall_0_3_0() { return cBoolOpBoolOpEnumRuleCall_0_3_0; }
		...
		//BoolExp
		public RuleCall getRightBoolExpParserRuleCall_0_5_0() { return cRightBoolExpParserRuleCall_0_5_0; }
		
		//')'
		public Keyword getRightParenthesisKeyword_0_6() { return cRightParenthesisKeyword_0_6; }
		
		//binaryBool=BinaryBoolExp
		public Assignment getBinaryBoolAssignment_1() { return cBinaryBoolAssignment_1; }
		
		//BinaryBoolExp
		public RuleCall getBinaryBoolBinaryBoolExpParserRuleCall_1_0() { return cBinaryBoolBinaryBoolExpParserRuleCall_1_0; }
	...
	public class BinaryBoolExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.BinaryBoolExp");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BinaryQntyExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.BinaryQntyExp");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cLeftAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class UnaryBoolExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.UnaryBoolExp");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class NegateBoolExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.NegateBoolExp");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cNotKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final RuleCall cBoolExpParserRuleCall_1 = (RuleCall)cGroup.eContents().get(1);
		...
		//BoolExp
		public RuleCall getBoolExpParserRuleCall_1() { return cBoolExpParserRuleCall_1; }
	}
	public class UnaryQuantityExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.UnaryQuantityExp");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Assignment cIdAssignment_0 = (Assignment)cAlternatives.eContents().get(0);
		private final CrossReference cIdAttributeCrossReference_0_0 = (CrossReference)cIdAssignment_0.eContents().get(0);
		private final RuleCall cIdAttributeIDTerminalRuleCall_0_0_1 = (RuleCall)cIdAttributeCrossReference_0_0.eContents().get(1);
	...
	public class AttrTypeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.AttrType");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class BooleanValueElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.BooleanValue");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class NumOpElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.NumOp");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class BoolOpElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufes.inf.StoryGen.BoolOp");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final EnumLiteralDeclaration cEQEnumLiteralDeclaration_0 = (EnumLiteralDeclaration)cAlternatives.eContents().get(0);
		private final Keyword cEQEqualsSignEqualsSignKeyword_0_0 = (Keyword)cEQEnumLiteralDeclaration_0.eContents().get(0);
		private final EnumLiteralDeclaration cNEQEnumLiteralDeclaration_1 = (EnumLiteralDeclaration)cAlternatives.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("br.ufes.inf.StoryGen".equals(grammar.getName())) {
				return grammar;
			}
