                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Acesso a plataforma CMPaaS</h3>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="" method="post" class="login-form">
			                        ...
			                        <button type="submit" class="btn" onclick="location.href='profile.php'">Entrar</button>
                                    <!-- <a href=""><h5 class="links-page text-center">Esqueci minha senha.</h5></a> -->
			                    </form>
		                    </div>
                        </div>
                    </div>
